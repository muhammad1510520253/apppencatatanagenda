...
public class AgendaPenting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agenda_penting);

        tvAgenda = findViewById(R.id.tvAgenda);
        agendaDAO = new AgendaDAOImp(this);
        setTitle("Agenda Penting");
        ReadAgenda();
...
//                    Toast.makeText(MainActivity.this,listBiodata.get(position).get("nim"), Toast.LENGTH_SHORT).show();
                final AlertDialog.Builder builder = new AlertDialog.Builder(AgendaPenting.this);
                final AlertDialog.Builder confirm = new AlertDialog.Builder(AgendaPenting.this);
                ...
                builder.setItems(pilihan, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int pilih) {
                        switch (pilih) {
                            case 0:
//                                TODO:TAMPIL DATA
                                Intent intent1 = new Intent(AgendaPenting.this, TampilAgenda.class);
...
//                              Toast.makeText(DaftarAgenda.this, "id nomer"+listAgenda.get(position).get("status"), Toast.LENGTH_SHORT).show();
                            ...
                            case 1:
//                                TODO:EDIT DATA
                                Intent intent = new Intent(AgendaPenting.this, CatatAgenda.class);
...
//                               TODO:HAPUS DATA
                                ...
                                confirm.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int i) {
                                        ...
                                        if (cek) {
                                            ReadAgenda();
                                            Toast.makeText(AgendaPenting.this, "Data Berhasil di Hapus", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(AgendaPenting.this, "Data Gagal di Hapus", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                                confirm.show();
    ...
    private void ReadAgenda() {
        ...
        Cursor cursor = agendaDAO.readpenting();
    ...
    public void tambahbaru(View view) {
        startActivity(new Intent(AgendaPenting.this, CatatAgenda.class));
    }
}
